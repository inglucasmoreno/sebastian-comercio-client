...
export class VentasPropiasChequesService {
  ...
  nuevaRelacion(data: any): Observable<any> {
    return this.http.post(`${base_url}/ventas-propias-cheques`, data, {
  ...
  getRelacion(id: string): Observable<any> {
    return this.http.get(`${base_url}/ventas-propias-cheques/${ id }`,{ 
      headers: this.getToken
    });
  };
  ...
  actualizarRelacion(id:string, data: any): Observable<any> {
    return this.http.put(`${base_url}/ventas-propias-cheques/${id}`, data, {
      headers: this.getToken
    });
  }  
