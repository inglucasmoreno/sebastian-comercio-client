...
export class ComprasCajasService {
  ...
  nuevaRelacion(data: any): Observable<any> {
    return this.http.post(`${base_url}/compras-cajas`, data, {
  ...
  getRelacion(id: string): Observable<any> {
    return this.http.get(`${base_url}/compras-cajas/${id}`, {
      headers: this.getToken
    });
  };
  ...
  listarRelaciones(parametros?: any): Observable<any> {
    return this.http.get(`${base_url}/compras-cajas`, {
      params: {
  ...
  actualizarRelaciones(id: string, data: any): Observable<any> {
    return this.http.put(`${base_url}/compras-cajas/${id}`, data, {
      headers: this.getToken
    });
  }
